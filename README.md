...
This library as able to pull completly into ```c:\Program Files (x86)\Arduino\libraries\ ``` folder for easy using on [Arduino IDE](https://www.arduino.cc/en/main/software).
